/**
 * ============================================================
 * UI/MAPVIEW.JS - RENDERIZADO DEL MAPA
 * Maneja Leaflet, marcadores, geocercas y leyenda
 * ============================================================
 */

import { GeocodingService } from '../services/geocoding.js';
import { COLORES_DIAS } from '../utils/constants.js';
import { 
    obtenerColorPorPais, 
    obtenerColorPorCanal, 
    obtenerColorPorTipoZona 
...
export class MapView {
        ...
        return `
            <div style="font-family: 'Inter', sans-serif; padding: 4px; min-width: 210px;">
                ...
                <div style="margin-top: 8px;">
                    <button onclick="window.APP.abrirModalVisitaCliente('${cliente.codigo}')" style="width:100%; background:${isVisited ? '#15803d' : '#1e3a8a'}; color:white; border:none; padding:7px; border-radius:8px; font-size:0.8rem; font-weight:700; cursor:pointer;">
    ...
    renderizarRutaOptima(routeData) {
        ...
        // Aquí se dibujaría la ruta optimizada en el mapa
