/**
 * ============================================================
 * STORE/INDEX.JS - GESTIÓN DE ESTADO GLOBAL
 * Patrón Flux para manejar el estado de la aplicación
 * ============================================================
 */

import { ACTIONS } from './types.js';
import { applyFilters, getFilteredGeofences } from './actions.js';
...
export class Store {
    ...
    isInsideGeofence(lat, lng) {
        // Placeholder - se implementa en GeocodingService
        return true;
    }
