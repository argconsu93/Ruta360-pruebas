import { normalizarTexto, coincidePais, coincideDivision, coincideGrupo, coincideRuta, coincideDia } from '../utils/helpers.js';
...
export function applyFilters(state) {
    ...
    return clients.filter(client => {
        // Filtro de búsqueda
        if (searchText && !client._searchCache.includes(searchText)) return false;
